...
Dictionary <- read_excel("Dictionary2.xlsx",range=cell_cols(2:10))
...
for(i in 1:1){
  ...
  for(c in 1:nrow(dict)){
    feature$LabResult<-ifelse(feature$LabEenh==dict[[c,3]]&!is.na(feature$LabResult)&!is.na(feature$LabEenh),feature$LabResult*dict[[c,4]],feature$LabResult)
  }
